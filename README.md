...
1. Uma lista de tarefas onde você consegue adicionar uma nova tarefa ou deletar uma tarefa(para carregar ou deletar a tarefa atualizada precisa clickar no botão de recarregar.)
...
5. Um botão que recarrega a listagem da tabela e atualiza.
6. Um mapeamento de todos os arquivos xhtml no meu projeto para que seja aberto em um tipo "jr".
